import java.io.*;
/**
 * The following class is used to return the books.
 * If the book is available or removed, the book cannot be returned.
 */
class returnbooks
{
    Encrypt en = new Encrypt();
    Decrypt de = new Decrypt();
    void returnX() throws Exception
    {
            ...
            while((text = fileInput.readLine()) != null)        
                {
                    ...
                    {
                       System.out.println("The following book " + arr[ent][1].trim() + " is issued.");
                       System.out.println("Press 1 to confirm return.");
                       ...
                       if(choice==1)
                       {
                            ...
                            */
                            ...
                            outFile.close();    
                            System.out.println("The following book: " + arr[ent][1].trim() + " was successfully returned and is now available.");
                            Thread.sleep(4000);
                            ob.menu();       
                        }
                       else if(choice==2)
                    ...
                    {
                        System.out.println("The following book " + arr[ent][1].trim() + " is not issued.\nInvalid Request.");
                        System.out.println("Cancelling...");
                        Thread.sleep(4000);
                        ob.menu();
                    }
                    ...
                    {
                        System.out.println("The following book " + arr[ent][1].trim() + " was removed earlier\nInvalid request.");
                        System.out.println("Cancelling...");
                        Thread.sleep(4000);
                        ob.menu();
                    }
